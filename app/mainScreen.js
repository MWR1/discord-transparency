...
function launchMainAppWindow(isVisible) {
  ...
  mainWindow.webContents.on('did-finish-load', () => {
    mainWindow.webContents.executeJavaScript('console.log("this is coming from first did-finish-load")');
 ...
 mainWindow.webContents.on('did-finish-load', () => {
	mainWindow.webContents.executeJavaScript('console.log("this is coming from the second did-finish-load")');
 });
