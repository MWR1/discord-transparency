            ...
            const e = {
                ...
                o = (function({ id: e, CSS: t }) {
                    ...
                    CSS: (({ backgroundImageURL: e, localBrightness: t }) =>
                        ...
                        {
                            backgroundImageURL: window.localStorage.getItem(
                                "bgImg"
                            ),
                            localBrightness:
                ...
                i = t => {
                    e.backgroundChangingInput.input.remove(),
                        ...
                        e.backgroundChangingInput.messageInputEl &&
                            (e.backgroundChangingInput.messageInputEl.style.display =
                                "initial");
                },
                l = r => {
                        ...
                        ("d" === t.key
                            ...
                            : t.altKey &&
                              (t => {
                                  if (
                                      (console.log(e),
                                      e.backgroundChangingInput.active)
                                  )
                                      return i();
                                  const n = a({
                                      type: "input",
                                  ...
                                  if (e.backgroundChangingInput.messageInputEl)
                                      e.backgroundChangingInput.messageInputEl.style.display =
                                          "none";
                                  else {
                                  ...
                                  document.body.appendChild(n),
                                      (e.backgroundChangingInput.active = !0),
                                      (e.backgroundChangingInput.input = n);
                              })());
                });
        })();
    }
